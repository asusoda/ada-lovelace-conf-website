...
export function AboutSection() {
  return (
    <section id="about" className="md:min-h-[calc(100vh+17rem)] lg:min-h-[calc(100vh+10rem)] xl:min-h-[calc(100vh+18rem)] 2xl:min-h-[calc(100vw-34rem)] bg-[var(--color-blue)] py-18 lg:py-32 lg:pb-12 overflow-hidden relative z-50">
